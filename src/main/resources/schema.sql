...
CREATE TABLE IF NOT EXISTS orders (
    ...
    buyer_id BIGINT NOT NULL,
    farmer_id BIGINT NOT NULL,
    crop_id BIGINT NOT NULL UNIQUE, -- One order per crop listing
    total_amount DECIMAL(10,2) NOT NULL,
    advance_amount DECIMAL(10,2) NOT NULL, -- 20%
    due_amount DECIMAL(10,2) NOT NULL,
    status ENUM('PENDING_ADVANCE', 'CONFIRMED', 'DELIVERED', 'COMPLETED', 'CANCELLED') DEFAULT 'PENDING_ADVANCE',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS blogs (
    ...
    title_bn VARCHAR(200), -- Bangla title
    content TEXT NOT NULL,
