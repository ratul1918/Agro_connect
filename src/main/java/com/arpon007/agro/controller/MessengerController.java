...
public class MessengerController {
        ...
        public ResponseEntity<Map<String, Object>> sendMessage(
                ...
                if (receiverId != null) {
                        jdbcTemplate.update(
                                        ...
                                        receiverId,
                                        sender.getFullName() + " sent you a message / আপনাকে একটি বার্তা পাঠিয়েছে");
                }
        ...
        /**
         * Delete a chat (soft delete - marks all messages as deleted)
         */
        ...
        public ResponseEntity<?> deleteChat(@PathVariable Long chatId, Authentication auth) {
                ...
                String checkSql = "SELECT COUNT(*) FROM chats WHERE id = ? AND (user1_id = ? OR user2_id = ?)";
                Integer count = jdbcTemplate.queryForObject(checkSql, Integer.class, chatId, user.getId(),
                                user.getId());

                if (count == null || count == 0) {
                        return ResponseEntity.badRequest()
                                        .body(Map.of("error", "Chat not found or you're not a participant"));
                }
